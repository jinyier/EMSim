...
if __name__ == "__main__":
    ...
    parser.add_argument("--clock_period_ns", type=int, default=41,
                        help="Amount of sample points per input stimuli")
    parser.add_argument("--start_time_ns", type=int, default=18,
                        help="Start time point in simulation per input stimuli")
    parser.add_argument("--end_time_ns", type=int, default=37,
                        help="End time point in simulation per input stimuli")
    parser.add_argument("--target_area_x", type=float, default=960 / 1000000,
                        help="Target simulated area in x axial direction")
    parser.add_argument("--target_area_y", type=float, default=960 / 1000000,
    ...
    parser.add_argument("--layout_max_z", type=float, default=2e-4,
    ...
    parser.add_argument("--layout_min_x", type=float, default=0 / 1000000,
                        help="Reference coordinate in x axial direction")
    parser.add_argument("--layout_min_y", type=float, default=0 / 1000000,
